...
public class WwwmirxapcomParse extends WebCrawler {
   ...
   // private final static String URL_PREFIX = "http://ti.tibet3.com/";
	...
	//朝文站点前缀
	private final static String URL_PREFIX = "http://www.mirxap.com";
    ...
    public void visit(Page page) {   
            ...
            if (page.getParseData() instanceof HtmlParseData) {
            	   //则把page对象解析出来的数据强制转换为htmlparsedata
                    ...
                    Elements contents_html = doc.select("td.mirxap_article_content");
                    if(!contents_html.isEmpty()){
                   	//标题部分
                    String title =doc.select("[height=70]").text();
                    //正文部分内容
                    String content = doc.select("td.mirxap_article_content").text();
                    ...
                    String timeofpublish =doc.select("[height=39],[height=40]").text().substring(6,16);
                    /////////////////////////////////
                    // 本url域名地址
                   // String domainname =templateUrl;
                    ...
                    //作者
                    //changed by jkd,27th Oct in 2014
                    String author=doc.select("[height=39],[height=40]").text().substring(18,doc.select("[height=39],[height=40]").text().length());
                    /////////////////////////////////
              ...
              //      System.out.println("获取格式检查"+dateOfPublish+"\n");
                    ...
                    SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");//设置日期格式
       			  ...
       			  //添加附加信息
                    String chinesename="新疆维文门户网";
                    String pinyin="xjwwmhw";
                    ...
                    //获取图片对应url地址
                    Elements E_image=doc.select(".mirxap_article_content div p a image");
