...
public class HttpnewsxinhuanetcomParse extends WebCrawler {
   ...
   // private final static String URL_PREFIX = "http://ti.tibet3.com/";
	...
	//朝文站点前缀
	private final static String URL_PREFIX = "http://www.xinhuanet.com/";
    ...
    public void visit(Page page) {   
            ...
            if (page.getParseData() instanceof HtmlParseData) {
            	   //则把page对象解析出来的数据强制转换为htmlparsedata
                    ...
                    Elements contents_html = doc.select(".content1");
                    if(!contents_html.isEmpty()){
                   	//标题部分
                    String title =doc.select(".main_tit h1").text();
                    //正文部分内容
                    String content = doc.select(".content1").text();
