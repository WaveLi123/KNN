...
public class WwwhljxinwencnParse extends WebCrawler {
   ...
   // private final static String URL_PREFIX = "http://ti.tibet3.com/";
	...
	//朝文站点前缀
	private final static String URL_PREFIX = "http://hljxinwen.dbw.cn";
    ...
    public void visit(Page page) {   
            ...
            if (page.getParseData() instanceof HtmlParseData) {
            	   //则把page对象解析出来的数据强制转换为htmlparsedata
                    ...
                    Elements contents_html = doc.select(".0014 p");
                    if(!contents_html.isEmpty()){
                    //正文部分内容
                    String content = contents_html.select(".0014 p").text();
                    //标题部分
                    String title =doc.select(".style1").text();
                    //发布时间 从对应html节点中获取字符串，然后截取获取需要的字符
                    String timeofpublish =doc.select(".00012 div").last().text();
                  ...
                  //  System.out.println("test:"+timeofpublish);
                   /* if(timeofpublish.isEmpty()){                   
                    ...
                    timeofpublish=timeofpublish.substring(timeofpublish.lastIndexOf("-")-7);
                    // 本url域名地址
                    String domainname =templateUrl;
                    //提供网站地址 
                    String provider= URL_PREFIX;
                    //作者
                    String author=content.substring(content.lastIndexOf("-")+1);
                  ...
                  System.out.println("获取格式检查"+dateOfPublish+"\n");
                    ...
                    SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");//设置日期格式
       			  ...
       			  //添加附加信息
                    String chinesename="黑龙江新闻朝语版";
                    String pinyin="hljxwcyb";
